...
def main(args):
  ...
  for sentence in inputs:
    ...
    for ne in sentence['named_entity']:
...
if __name__ == '__main__':
  ...
  parser.add_argument('--src-file', type=str, help="JSON file, output of generate_kmdp.py")
  parser.add_argument('--dst-file', type=str, help="JSON output file, VictorNLP label format")
